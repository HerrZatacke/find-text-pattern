...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const init = () => {
    ...
    addRomPart.innerText = 'from 0x1E2C8';
  ...
  const update = () => {
    ...
    mapped.forEach((mappedChar, index) => {
      const charNode = document.createElement('code');
      ...
      renderedInput.appendChild(charNode);
    });
  };
